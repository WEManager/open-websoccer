...
use App\Classes\Events\UserRegisteredEvent;
use App\Classes\I18n;
use App\Classes\PluginMediator;
...
class UsersDataService {
	 ...
	 */
	public static function createLocalUser(WebSoccer $websoccer, DbConnection $db, string $nick = null, string $email = null) {
		$username = trim($nick);
