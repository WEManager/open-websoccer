...
class WebSoccer {
	...
	private $_skin;
	private $_pageId;
	private Template $_templateEngine;
	...
	/**
	 * @return WebSoccer only instance during current request.
	 */
	 ...
	 */
	public function getTemplateEngine(I18n $i18n, ViewHandler $viewHandler = null) {	
		return $this->_templateEngine ?? new TemplateEngine($this, $i18n, $viewHandler);
	}
